...
$env:ADAPTER_LIFECYCLE_LOG='C:\Users\noahj\Downloads\Minecraft ML\data\phase21-one-seed-12002-stone-pickaxe-at-3\eval-12002-adapter-lifecycle.jsonl'
$env:MINECRAFT_PORT='25760'
$env:DIRECT_GOAL='bootstrap 1 iron_ingot'
$env:BRAIN_DATA_DIR='C:\Users\noahj\Downloads\Minecraft ML\data\phase21-one-seed-12002-stone-pickaxe-at-3'
