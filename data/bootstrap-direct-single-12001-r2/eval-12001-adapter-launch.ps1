...
$env:ADAPTER_LIFECYCLE_LOG='C:\Users\noahj\Downloads\Minecraft ML\data\bootstrap-direct-single-12001-r2\eval-12001-adapter-lifecycle.jsonl'
$env:MINECRAFT_PORT='25567'
$env:DIRECT_GOAL='bootstrap 1 iron_ingot'
$env:BRAIN_DATA_DIR='C:\Users\noahj\Downloads\Minecraft ML\data\bootstrap-direct-single-12001-r2'
